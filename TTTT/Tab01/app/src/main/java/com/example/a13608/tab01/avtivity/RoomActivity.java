...
public class RoomActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        //Toast.makeText(RoomActivity.this, position, Toast.LENGTH_SHORT).show();
        /**
         * 将position发送给服务器端
         */
        ...
        connection(position);
        //initDesk("AAAAAABAABBCDDABAAAABAABBCDDABAAAABAAABBCDDABAAAABAABBCDDABAAAABAABBCDDABAAAABAABBCDDABAAAABAABBCDDABAAAABAABBCDDABAAAABAABBCDDAB");
    ...
    private void connection(String position) {
        String url1="http://172.21.57.82:8080/AndroidWeb/QuaRoom";
